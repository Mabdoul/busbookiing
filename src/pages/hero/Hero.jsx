  ...
  return (
    <div className="w-full h-[calc(100vh-8ch)] lg:ps-28 md:ps-16 sm:ps-7 ps-4 mt-[8ch] flex items-center justify-center flex-col hero relative">
      <div className="flex-1 w-full flex items-stretch justify-between gap-12 pb-10">
        <motion.div
          className="lg:w-[40%] md:w-[50%] sm:w-[60%] w-full h-auto rounded-md flex justify-center flex-col space-y-14"
    ...
    >
      Reserve Seat Now
        ...
        <div className="lg:w-[60%] md:w-[50%] sm:w-[40%] w-full h-full rounded-md flex items-end justify-end absolute top-0 right-1 left-100 z-0">
          <motion.img
