  ...
  return (
    <div className='w-full lg:px-28 md:px-16 sm:px-7 px-4 mb-[8ch]'>
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className='absolute top-0 left-0 w-full h-full bg-gradient-to-tr dark:from-nutral-950/80 dark:to-neutral-950/60 from-neutral-400/80 to-neutral-400/60 group-hover:flex hidden items-center justify-center ease-in-out duration-300 '>
            <h2 className="text-2xl-bold text-center text-neutral-900 dark:text-neutral-50">
            Private Bus
            </h2>
          </div>
          </Link>
