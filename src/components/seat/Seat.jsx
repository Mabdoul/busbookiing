// src/components/seat/BusSeatLayout.js
...
const BusSeatLayout = ({ onSeatSelect }) => {
  const totalSeats = 41;
  ...
  const handleSeatClick = (seatNumber) => {
    ...
    onSeatSelect(updatedSeats); // Call the callback with the selected seats
  };
    ...
    <div className="space-y-5">
      ...
      {selectedSeats.length > 0 && (
        <div className="!mt-5 flex items-center gap-x-4">
          ...
          <p className="text-lg font-medium">MAD {selectedSeats.length * 75}</p>
